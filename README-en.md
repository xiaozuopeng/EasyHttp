...
* [Click here to download demo apk directly](https://github.com/getActivity/EasyHttp/releases/download/13.8/EasyHttp.apk)
...
dependencies {
    ...
    implementation 'com.github.getActivity:EasyHttp:13.8'
...
| :----: | :------: |  :-----: |  :-----: |
|    Supported Version  |  13.8 |  2.9.0  |  3.0.4    |
