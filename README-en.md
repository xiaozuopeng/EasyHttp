...
* [Click here to download demo apk directly](https://github.com/getActivity/EasyHttp/releases/download/13.6/EasyHttp.apk)
...
dependencies {
    ...
    implementation 'com.github.getActivity:EasyHttp:13.6'
...
| :----: | :------: |  :-----: |  :-----: |
|    Supported Version  |  13.6 |  2.9.0  |  3.0.4    |
